...
<section class="hero">
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-eyebrow">🇮🇹 Italiano · PACK A1+A2+B1 · Apto ciudadanía</div>
            <h1>Pack italiano <span class="grad">de cero a avanzado</span></h1>
            <p class="hero-sub">Los 3 niveles juntos con descuento. Empezás desde cero y llegás al B1, el nivel apto para ciudadanía italiana. Más económico que comprarlos por separado.</p>
...
<li><span class="check">✓</span> Soporte de profes online</li>
        ...
        <div class="hero-visual">
            <span class="hero-flag"><span class="flag-icon">🇮🇹</span> Tutto in uno!</span>
            <img src="../img/curso-italiano-pack.svg" alt="Pack Italiano Avanzado A1+A2+B1 con Descuento | Aprende Idiomas" class="hero-img">
            <div class="hero-rating">
                <div class="hero-rating-stars">★★★★★</div>
                <div class="hero-rating-text"><b>4.9 de 5</b>+800 alumnos</div>
            </div>
        </div>
    </div>
</section>
...
<section class="prose">
    <div class="prose-inner">
        ...
        <div class="prose-stats">
            ...
            <span><b>+800 estudiantes</b> ya empezaron</span>
        </div>
    </div>
</section>
...
<section class="learn">
    <div class="learn-inner">
        ...
        <div class="learn-content">
            ...
            <ul class="learn-list">
                <li><span class="check">1</span> Nivel A1: Bases, presente, vocabulario</li>
                <li><span class="check">2</span> Nivel A2: Pasado, pronombres, modales</li>
                <li><span class="check">3</span> Nivel B1: Subjuntivo, condicional, hipótesis</li>
                <li><span class="check">4</span> Vocabulario para la vida real italiana</li>
                <li><span class="check">5</span> Preparación para examen CILS B1</li>
                <li><span class="check">6</span> Apto requisito ciudadanía italiana</li>
            </ul>
        </div>
    </div>
</section>
...
<section class="syllabus" id="temario">
    <div class="syllabus-inner">
        <div class="syllabus-content">
            ...
            <p>+90 clases paso a paso, organizadas para que avances sin perderte.</p>

            <details>
                <summary class="syllabus-toggle">
                    <span>Ver temario completo (90 clases)</span>
                    <span class="arrow">▼</span>
                </summary>
                <ul class="syllabus-list">
                    <li><span class="num">01</span> ═══ NIVEL A1 ═══</li>
                    ...
                    <li><span class="num">05</span> Días, meses, estaciones</li>
                    <li><span class="num">06</span> Artículos determinativos</li>
                    <li><span class="num">07</span> Saludos y presentaciones</li>
                    <li><span class="num">08</span> La familia</li>
                    <li><span class="num">09</span> Presente indicativo</li>
                    <li><span class="num">10</span> Lecturas A1</li>
                    <li><span class="num">11</span> ═══ NIVEL A2 ═══</li>
                    <li><span class="num">12</span> Passato prossimo</li>
                    <li><span class="num">13</span> Imperfetto</li>
                    <li><span class="num">14</span> Pronombres directos e indirectos</li>
                    <li><span class="num">15</span> Verbos modales</li>
                    <li><span class="num">16</span> Comparativos y superlativos</li>
                    <li><span class="num">17</span> Vocabulario avanzado A2</li>
                    <li><span class="num">18</span> Conversación A2</li>
                    <li><span class="num">19</span> Lecturas A2</li>
                    <li><span class="num">20</span> ═══ NIVEL B1 ═══</li>
                    <li><span class="num">21</span> Congiuntivo (4 tiempos)</li>
                    <li><span class="num">22</span> Condizionale</li>
                    <li><span class="num">23</span> Periodo ipotetico</li>
                    <li><span class="num">24</span> Discurso indirecto</li>
                    <li><span class="num">25</span> Forma passiva</li>
                    <li><span class="num">26</span> Vocabulario B1</li>
                    <li><span class="num">27</span> Preparación CILS B1</li>
                    <li><span class="num">28</span> Simulación examen</li>
                    <li><span class="num">29</span> Repaso final del pack</li>
                </ul>
            </details>
        </div>
    </div>
    ...
    <div class="testimonials-inner">
        ...
        <div class="testimonials-grid">
            <div class="testimonial">
                ...
                <p class="testimonial-text">"Compré el pack y fue la mejor decisión. Mucho más barato."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">AM</span>
                    <div class="testimonial-info"><span class="testimonial-name">Adriana Marchetti</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"De cero a B1 en menos de un año. Increíble."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">RG</span>
                    <div class="testimonial-info"><span class="testimonial-name">Raúl Genovese</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Aprobé la ciudadanía italiana. Gracias!"</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">CC</span>
                    <div class="testimonial-info"><span class="testimonial-name">Carolina Carbone</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Los 3 niveles bien conectados. Excelente."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">HL</span>
                    <div class="testimonial-info"><span class="testimonial-name">Hernán Locatelli</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Inversión que vale cada peso. Súper recomendado."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">NS</span>
                    <div class="testimonial-info"><span class="testimonial-name">Natalia Spinelli</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"El temario completo me sorprendió. Muy completo."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">OD</span>
                    <div class="testimonial-info"><span class="testimonial-name">Oscar Della Valle</span></div>
                </div>
            </div>
...
<section class="final-cta">
    <div class="final-cta-inner">
        <img src="../img/curso-italiano-pack.svg" alt="Empezá hoy" class="final-cta-img">
