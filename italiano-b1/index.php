...
<section class="hero">
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-eyebrow">🇮🇹 Italiano · Nivel B1 · Avanzado · Apto ciudadanía</div>
            <h1>Italiano nivel <span class="grad">avanzado B1</span></h1>
            <p class="hero-sub">El nivel exigido para la ciudadanía italiana. Subjuntivo, condicional, conversación fluida y comprensión avanzada. Apto requisito legal CILS B1.</p>
...
<li><span class="check">✓</span> Soporte de profes online</li>
        ...
        <div class="hero-visual">
            <span class="hero-flag"><span class="flag-icon">🇮🇹</span> Perfetto!</span>
            <img src="img/curso-italiano-b1.svg" alt="Italiano B1 — Nivel Avanzado · Apto Ciudadanía | Aprende Idiomas" class="hero-img">
            <div class="hero-rating">
                <div class="hero-rating-stars">★★★★★</div>
                <div class="hero-rating-text"><b>4.9 de 5</b>+1.200 alumnos</div>
            </div>
        </div>
    </div>
</section>
...
<section class="prose">
    <div class="prose-inner">
        <p>El B1 es el nivel que <b>te habilita la ciudadanía italiana</b>. Tras este curso vas a manejar conversaciones complejas, leer textos avanzados y rendir exámenes oficiales como CILS o CELI con confianza.</p>
        <p>Construido para preparar el examen oficial, este curso te lleva al <span class="highlight-text">nivel B1 del MCER</span> con todo lo que necesitás para certificarte.</p>
        <div class="no-req">✦ Sin requisitos previos</div>
        <div class="prose-stats">
            <span class="stars">★★★★★</span>
            <span><b>+1.200 estudiantes</b> ya empezaron</span>
        </div>
    </div>
</section>
...
<section class="learn">
    <div class="learn-inner">
        <img src="img/curso-italiano-b1.svg" alt="Aprenderás italiano" class="learn-img">
        <div class="learn-content">
            ...
            <ul class="learn-list">
                <li><span class="check">1</span> Congiuntivo presente, passato e imperfetto</li>
                <li><span class="check">2</span> Condizionale presente y passato</li>
                <li><span class="check">3</span> Discurso indirecto</li>
                <li><span class="check">4</span> Periodo ipotetico (los 3 tipos)</li>
                <li><span class="check">5</span> Vocabulario avanzado: trabajo, política, cultura</li>
                <li><span class="check">6</span> Preparación examen CILS / CELI B1</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="syllabus-content">
            ...
            <details>
                ...
                <ul class="syllabus-list">
                    <li><span class="num">01</span> Repaso A2</li>
                    <li><span class="num">02</span> Congiuntivo presente</li>
                    <li><span class="num">03</span> Congiuntivo passato</li>
                    <li><span class="num">04</span> Congiuntivo imperfetto</li>
                    <li><span class="num">05</span> Congiuntivo trapassato</li>
                    <li><span class="num">06</span> Condizionale presente</li>
                    <li><span class="num">07</span> Condizionale passato</li>
                    <li><span class="num">08</span> Periodo ipotetico tipo 1</li>
                    <li><span class="num">09</span> Periodo ipotetico tipo 2</li>
                    <li><span class="num">10</span> Periodo ipotetico tipo 3</li>
                    <li><span class="num">11</span> Discorso indiretto</li>
                    <li><span class="num">12</span> Forma passiva</li>
                    <li><span class="num">13</span> Si impersonale</li>
                    <li><span class="num">14</span> Pronomi relativi</li>
                    <li><span class="num">15</span> Connettivi del discorso</li>
                    <li><span class="num">16</span> Vocabulario: lavoro</li>
                    <li><span class="num">17</span> Vocabulario: politica</li>
                    <li><span class="num">18</span> Vocabulario: cultura</li>
                    <li><span class="num">19</span> Vocabulario: cucina italiana</li>
                    <li><span class="num">20</span> Espressioni idiomatiche</li>
                    <li><span class="num">21</span> Lectura: Articoli di giornale</li>
                    <li><span class="num">22</span> Lectura: Testi letterari</li>
                    <li><span class="num">23</span> Listening: Notizie</li>
                    <li><span class="num">24</span> Listening: Interviste</li>
                    <li><span class="num">25</span> Writing: Email formali</li>
                    <li><span class="num">26</span> Writing: Saggi</li>
                    <li><span class="num">27</span> Simulación examen CILS B1</li>
                    <li><span class="num">28</span> Tips para el examen oficial</li>
                    <li><span class="num">29</span> Repaso final</li>
                </ul>
            </details>
        </div>
    </div>
    ...
    <div class="testimonials-inner">
        ...
        <div class="testimonials-grid">
            <div class="testimonial">
                ...
                <p class="testimonial-text">"Aprobé el CILS B1 a la primera. Este curso fue clave."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">RC</span>
                    <div class="testimonial-info"><span class="testimonial-name">Roxana Carballo</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Camino a la ciudadanía. Excelente preparación."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">MD</span>
                    <div class="testimonial-info"><span class="testimonial-name">Matías D'Angelo</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"El congiuntivo dejó de ser un misterio."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">CV</span>
                    <div class="testimonial-info"><span class="testimonial-name">Clara Vespucci</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Recomendado para el examen oficial. Muy completo."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">LF</span>
                    <div class="testimonial-info"><span class="testimonial-name">Lucas Falcone</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Las explicaciones de gramática son impecables."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">AB</span>
                    <div class="testimonial-info"><span class="testimonial-name">Agustina Bevilacqua</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Si querés la ciudadanía, este es EL curso."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">FN</span>
                    <div class="testimonial-info"><span class="testimonial-name">Federico Negroni</span></div>
                </div>
            </div>
...
<section class="faq">
    ...
    <div class="faq-inner">
        ...
        <details class="faq-item">
            ...
            <div class="faq-body">No hay requisitos previos. Este curso es para que avances con italiano a tu propio ritmo.</div>
        </details>
        <details class="faq-item">
...
<section class="final-cta">
    <div class="final-cta-inner">
        <img src="img/curso-italiano-b1.svg" alt="Empezá hoy" class="final-cta-img">
