...
<head>
    <meta charset="utf-8">
    <title>Checkout · Italiano B1 | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/italiano-b1/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">Perfetto!</div>
            <div class="co-hero-viz-words">
                <span class="w1">Famiglia</span>
                <span class="w2">Roma</span>
                <span class="w3">Cultura</span>
            </div>
            <div class="co-hero-viz-tag">✦ Italiano B1</div>
        </div>
        <div>
            <div class="co-top-badge">🇮🇹 Italiano</div>
            <h1>Estás a un paso.<br><span class="grad">Italiano B1</span></h1>
            <p>Avanzado · Apto ciudadanía italiana · Acceso inmediato después del pago · Garantía 7 días</p>
        </div>
    </div>
</section>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-feat">
            <li><span class="check">✓</span> Congiuntivo y condizionale</li>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"Aprobé el CILS B1 a la primera. Este curso fue clave."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">RC</span>
                <div><div class="co-test-name">Roxana Carballo</div><div class="co-test-loc">CABA</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Camino a la ciudadanía. Excelente preparación."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">MD</span>
                <div><div class="co-test-name">Matías D'Angelo</div><div class="co-test-loc">Mar del Plata</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"El congiuntivo dejó de ser un misterio."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">CV</span>
                <div><div class="co-test-name">Clara Vespucci</div><div class="co-test-loc">Rosario</div></div>
            </div>
        </div>
    </div>
</section>
