...
<head>
    <meta charset="utf-8">
    <title>Alemán — Curso Online desde cero | Aprende Idiomas</title>
    <meta name="description" content="Curso de alemán nivel inicial. Desde cero, +26 clases, certificado oficial, comunidad y acceso de por vida.">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            /* Colores Italia */
            --it-green: #d97706;
            --it-green-deep: #92400e;
            --it-green-soft: #fef3c7;
            --it-red: #be123c;
            --it-red-soft: #fee2e2;
            --it-cream: #fef9f0;
            ...
            --shadow-it: 0 12px 32px rgba(217,119,6,.32);
        ...
        .hero {
            ...
            background:
                ...
                radial-gradient(ellipse 60% 50% at 0% 100%, rgba(217,119,6,.10), transparent 60%),
                #fff;
        }
        .hero::after {
            content: '';
        ...
        .btn-it:hover {
            ...
            box-shadow: 0 16px 40px rgba(217,119,6,.45);
        }
        .btn-light {
            background: #fff;
            color: var(--ink);
        ...
        .syllabus-inner::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 80% 20%, rgba(217,119,6,.30), transparent 50%),
        ...
        .testimonials::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 80% 20%, rgba(217,119,6,.20), transparent 50%),
        ...
        .testimonials .section-head .eyebrow { background: rgba(217,119,6,.2); color: #5fd687; }
...
<section class="hero">
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-eyebrow">🇩🇪 Alemán · Inicial · Desde cero</div>
            <h1>Aprendé alemán <span class="grad">desde cero</span></h1>
            <p class="hero-sub">El idioma más hablado de Europa. Apto para trabajo, estudios universitarios y vivir en Alemania. +25 clases paso a paso, acceso de por vida.</p>
...
<li><span class="check">✓</span> Soporte de profes online</li>
        ...
        <div class="hero-visual">
            <span class="hero-flag"><span class="flag-icon">🇩🇪</span> Hallo!</span>
            <img src="../img/aleman1.png" alt="Alemán" class="hero-img">
            <div class="hero-rating">
                <div class="hero-rating-stars">★★★★★</div>
                <div class="hero-rating-text"><b>4.9 de 5</b>+1.500 alumnos</div>
            </div>
        </div>
    </div>
</section>
...
<section class="banner-it">
    ...
    <h2>La mejor forma de aprender alemán a nivel mundial</h2>
</section>

<!-- ============ INTRO PROSE ============ -->
<section class="prose">
    <div class="prose-inner">
        <p>El alemán es hablado por más de <b>100 millones de personas</b> en Europa y es la puerta a universidades y empresas alemanas. Empezar desde cero es más fácil de lo que pensás.</p>
        <p>Este curso te lleva a las bases del alemán con <span class="highlight-text">+25 clases paso a paso</span>, pronunciación, vocabulario esencial y gramática básica.</p>
        <div class="no-req">✦ Sin requisitos previos</div>
        <div class="prose-stats">
            <span class="stars">★★★★★</span>
            <span><b>+1.500 estudiantes</b> ya empezaron</span>
        </div>
    </div>
</section>
...
<section class="learn">
    <div class="learn-inner">
        <img src="../img/aleman1.png" alt="Aprenderás alemán" class="learn-img">
        <div class="learn-content">
            ...
            <ul class="learn-list">
                <li><span class="check">1</span> Alfabeto y pronunciación alemana</li>
                <li><span class="check">2</span> Artículos (der, die, das)</li>
                <li><span class="check">3</span> Verbos regulares e irregulares en presente</li>
                <li><span class="check">4</span> Casos nominativo y acusativo</li>
                <li><span class="check">5</span> Vocabulario cotidiano</li>
                <li><span class="check">6</span> Frases y conversación básica</li>
            </ul>
        </div>
    </div>
</section>
...
<section class="benefits">
    ...
    <div class="benefits-grid">
        ...
        <div class="benefit">
            ...
            <p>Espacio exclusivo para que practiques alemán con otros alumnos y profes.</p>
        </div>
</div>
</section>
...
<section class="syllabus" id="temario">
    <div class="syllabus-inner">
        <div class="syllabus-content">
            ...
            <p>+26 clases paso a paso, organizadas para que avances sin perderte.</p>

            <details>
                <summary class="syllabus-toggle">
                    <span>Ver temario completo (26 clases)</span>
                    <span class="arrow">▼</span>
                </summary>
                <ul class="syllabus-list">
                    <li><span class="num">01</span> Alfabeto alemán</li>
                    <li><span class="num">02</span> Sonidos especiales (ä, ö, ü, ß)</li>
                    <li><span class="num">03</span> Saludos formales e informales</li>
                    <li><span class="num">04</span> Pronombres personales</li>
                    <li><span class="num">05</span> Verbo Sein (ser)</li>
                    <li><span class="num">06</span> Verbo Haben (tener)</li>
                    <li><span class="num">07</span> Números 1-100</li>
                    <li><span class="num">08</span> Colores</li>
                    <li><span class="num">09</span> Días y meses</li>
                    <li><span class="num">10</span> Artículos determinativos (der/die/das)</li>
                    <li><span class="num">11</span> Artículos indeterminativos</li>
                    <li><span class="num">12</span> Plurales</li>
                    <li><span class="num">13</span> Género de los sustantivos</li>
                    <li><span class="num">14</span> Presente indicativo (regular)</li>
                    <li><span class="num">15</span> Verbos modales</li>
                    <li><span class="num">16</span> La familia</li>
                    <li><span class="num">17</span> Partes de la casa</li>
                    <li><span class="num">18</span> Comida y bebidas</li>
                    <li><span class="num">19</span> Profesiones</li>
                    <li><span class="num">20</span> Nacionalidades</li>
                    <li><span class="num">21</span> Preguntas con W- (wer/was/wo)</li>
                    <li><span class="num">22</span> Negación con nicht/kein</li>
                    <li><span class="num">23</span> Caso nominativo</li>
                    <li><span class="num">24</span> Caso acusativo</li>
                    <li><span class="num">25</span> Primera lectura</li>
                    <li><span class="num">26</span> Segunda lectura</li>
                    <li><span class="num">27</span> Ejercicios finales</li>
                </ul>
            </details>
        </div>
    </div>
    ...
    <div class="testimonials-inner">
        ...
        <div class="testimonials-grid">
            <div class="testimonial">
                ...
                <p class="testimonial-text">"Arrancé para estudiar en Alemania y el curso me dio una base sólida."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">TL</span>
                    <div class="testimonial-info"><span class="testimonial-name">Tomás L.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"La pronunciación de los ä y ö me costaba un montón, acá los entendí."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">SR</span>
                    <div class="testimonial-info"><span class="testimonial-name">Sofía R.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Perfecto para empezar de cero. Voy a seguir con niveles más avanzados."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">MC</span>
                    <div class="testimonial-info"><span class="testimonial-name">Mateo C.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Los casos nominativo y acusativo se entienden perfecto."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">LB</span>
                    <div class="testimonial-info"><span class="testimonial-name">Lucía B.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Excelente para quienes sueñan con trabajar en Alemania."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">FM</span>
                    <div class="testimonial-info"><span class="testimonial-name">Facundo M.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Ideal para bases sólidas. Muy recomendado."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">CH</span>
                    <div class="testimonial-info"><span class="testimonial-name">Carolina H.</span></div>
                </div>
            </div>
...
<section class="faq">
    ...
    <div class="faq-inner">
        ...
        <details class="faq-item">
            ...
            <div class="faq-body">No hay requisitos previos. Este curso es para que avances con alemán a tu propio ritmo.</div>
        </details>
        <details class="faq-item">
...
<section class="final-cta">
    <div class="final-cta-inner">
        <img src="../img/aleman1.png" alt="Empezá hoy" class="final-cta-img">
        <div class="final-cta-content">
            <div class="hero-eyebrow">🇩🇪 Empezá hoy</div>
            <h2>Sumá alemán a tu CV</h2>
