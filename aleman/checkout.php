...
<html>
    ...
    <body style="font-family: montserrat_regular;">
        ...
        <!-- Website Sections -->
        <div class="pt-5" style="background-color:#F00">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="imagenes/aleman1.png"> </div>
        ...
        <div class="text-white jp_banner_jobs_categories_wrapper bg-white float_left pt-5 pb-0 mx-auto mx-1">
                    ...
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0 text-dark">Curso de alemán Inicial</h6> <small class="text-muted">De por vida</small>
                        ...
                        <div class="row mx-2 ">
                            <div class="col-md-12 text-dark">
                                ...
                                <ul>
                                    <li> <i class="fas fa-check-square " style="color:#00a8f3;"></i> Descargá el curso y miralo sin conexión!</li>
                                    <li> <i class="fas fa-check-square " style="color:#00a8f3;"></i> 74 clases</li>
                            ...
                            <div class=" col-md-12" style="">
                                <div class=" mb-0 text-dark">
                                    <p>"Con este curso pude introducirme en este idioma tan genial.
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Martin Fleitas</b>, Provincia de Buenos Aires</div>
                                </div>
                                <hr>
                                <div class=" mb-0 text-dark">
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Micaela Gonzalez</b>, Provincia de Buenos Aires</div>
                                </div>
                                <hr>
                                <div class=" mb-0 text-dark">
                                    <p>"Videos cortos, sencillas y al grano. Recomendado"
                                    </p>
                                    <div class="rating-user d-inline">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
            ...
            <div class="py-5 text-center">
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" target="_blank" href="https://api.whatsapp.com/send?phone=5491164402284&amp;text=Hola!%20Te%20escribo%20por%20el%20Curso%20de%20Aleman"> <img class="img-fluid d-block mx-auto mx-md-1" src="../img/whatsapp.jpg"></a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
            ...
            <div class="container row mt-5 mx-auto text-dark">
                <div class="col-md-4 col-4">
                    <img class="img-fluid d-block mx-auto" src="/aleman/imagenes/badge1.jpg" draggable="true">
                    <p class=" text-center" draggable="true">Protegemos tu privacidad</p>
                </div>
                <div class="col-md-4 col-4">
                    <img class="img-fluid d-block mx-auto" src="/aleman/imagenes/badge2.jpg">
                    <p class="pi-draggable text-center" draggable="true">Tus datos están seguros</p>
                </div>
                <div class="col-md-4 col-4">
                    <img class="img-fluid d-block mx-auto" src="/aleman/imagenes/badge3.jpg">
