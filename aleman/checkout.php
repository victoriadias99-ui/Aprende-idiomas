...
<head>
    <meta charset="utf-8">
    <title>Checkout · Alemán | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/aleman/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">Hallo!</div>
        ...
        <div>
            <div class="co-top-badge">🇩🇪 Alemán</div>
            <h1>Estás a un paso.<br><span class="grad">Alemán</span></h1>
            <p>Inicial · Desde cero · Acceso inmediato después del pago · Garantía 7 días</p>
        </div>
    </div>
</section>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-order">
            <li>
                <div>
                    <div class="item-name">Alemán</div>
</div>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"Arrancé para estudiar en Alemania y el curso me dio una base sólida."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">TL</span>
                <div><div class="co-test-name">Tomás L.</div><div class="co-test-loc">Buenos Aires</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"La pronunciación de los ä y ö me costaba un montón, acá los entendí."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">SR</span>
                <div><div class="co-test-name">Sofía R.</div><div class="co-test-loc">Córdoba</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Perfecto para empezar de cero. Voy a seguir con niveles más avanzados."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">MC</span>
                <div><div class="co-test-name">Mateo C.</div><div class="co-test-loc">Rosario</div></div>
            </div>
        </div>
    </div>
</section>
