...
<section class="prose">
    <div class="prose-inner">
        <p>Hablado por más de <b>1.500 millones de personas</b> en el mundo, el inglés es el idioma de los negocios, la tecnología y la cultura global. Saberlo hoy es una de las inversiones más rentables que podés hacer.</p>
        <p>A través de este curso vas a aprender los <b>verbos esenciales</b>, los <b>tiempos verbales básicos</b> y vocabulario para conversar. Explicado paso a paso por nuestro profesor <span class="highlight-text">con más de 15 años de trayectoria</span>.</p>
        <div class="no-req">✦ Sin requisitos previos</div>
        <div class="prose-stats">
            <span class="stars">★★★★★</span>
            <span><b>+5.000 estudiantes</b> ya empezaron</span>
        </div>
    </div>
</section>
...
<section class="learn">
    <div class="learn-inner">
        ...
        <div class="learn-content">
            ...
            <ul class="learn-list">
                <li><span class="check">1</span> Pronombres personales y verbo To Be</li>
                <li><span class="check">2</span> Presente simple y continuo</li>
                <li><span class="check">3</span> Vocabulario para conversar a diario</li>
                <li><span class="check">4</span> Lecturas y ejercicios de comprensión</li>
                <li><span class="check">5</span> Pronunciación clara desde el inicio</li>
                <li><span class="check">6</span> Números, colores, días y mucho más</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="syllabus-content">
            ...
            <details>
                ...
                <ul class="syllabus-list">
                    <li><span class="num">01</span> Pronouns y To Be</li>
                    <li><span class="num">02</span> Verb To Have</li>
                    <li><span class="num">03</span> Numbers 1-100</li>
                    <li><span class="num">04</span> Colors</li>
                    <li><span class="num">05</span> Days of the week</li>
                    <li><span class="num">06</span> Months & seasons</li>
                    <li><span class="num">07</span> Weather</li>
                    <li><span class="num">08</span> Articles a/an/the</li>
                    <li><span class="num">09</span> Family vocabulary</li>
                    <li><span class="num">10</span> House vocabulary</li>
                    <li><span class="num">11</span> Animals</li>
                    <li><span class="num">12</span> Food & drink</li>
                    <li><span class="num">13</span> Body parts</li>
                    <li><span class="num">14</span> Present simple affirmative</li>
                    <li><span class="num">15</span> Present simple negative</li>
                    <li><span class="num">16</span> Present simple questions</li>
                    <li><span class="num">17</span> Adverbs of frequency</li>
                    <li><span class="num">18</span> Telling the time</li>
                    <li><span class="num">19</span> Daily routines</li>
                    <li><span class="num">20</span> Hobbies & free time</li>
                    <li><span class="num">21</span> Possessives</li>
                    <li><span class="num">22</span> Prepositions of place</li>
                    <li><span class="num">23</span> There is / there are</li>
                    <li><span class="num">24</span> Can / cannot</li>
                    <li><span class="num">25</span> Imperatives</li>
                    <li><span class="num">26</span> Reading 1: My day</li>
                    <li><span class="num">27</span> Reading 2: My family</li>
                    <li><span class="num">28</span> Listening practice</li>
    ...
    <div class="testimonials-inner">
        ...
        <div class="testimonials-grid">
            <div class="testimonial">
                ...
                <p class="testimonial-text">"Empecé desde cero y a las 3 semanas ya entendía videos. ¡Recomendado!"</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">MJ</span>
                    <div class="testimonial-info"><span class="testimonial-name">Mariela Juárez</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"El profe explica re claro. La mejor inversión que hice."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">RF</span>
                    <div class="testimonial-info"><span class="testimonial-name">Ricardo Fernández</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Las clases son cortas y se entienden perfecto. Ideal para principiantes."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">LP</span>
                    <div class="testimonial-info"><span class="testimonial-name">Lucía Paredes</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Llevaba años queriendo aprender inglés. Este curso me destrabó."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">DC</span>
                    <div class="testimonial-info"><span class="testimonial-name">Diego Cabrera</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Los ejercicios prácticos son lo mejor. Aprendí mucho."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">AS</span>
                    <div class="testimonial-info"><span class="testimonial-name">Ana Suárez</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Lo recomiendo 100%. Vale cada peso."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">MV</span>
                    <div class="testimonial-info"><span class="testimonial-name">Martín Velázquez</span></div>
                </div>
            </div>
