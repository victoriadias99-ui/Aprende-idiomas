...
<head>
    <meta charset="utf-8">
    <title>Checkout · Inglés Nivel 1 | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/ingles-nivel-uno/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">Hello!</div>
            <div class="co-hero-viz-words">
                <span class="w1">Hello</span>
                <span class="w2">World</span>
                <span class="w3">Future</span>
            </div>
            <div class="co-hero-viz-tag">✦ English</div>
        </div>
        <div>
            <div class="co-top-badge">🇺🇸 Inglés</div>
            <h1>Estás a un paso.<br><span class="grad">Inglés Nivel 1</span></h1>
            <p>Desde cero · Principiantes · Acceso inmediato después del pago · Garantía 7 días</p>
        </div>
    </div>
</section>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-order">
            <li>
                <div>
                    <div class="item-name">Inglés Nivel 1</div>
</div>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"Muy completo el curso, ideal para principiantes. Excelente."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">GM</span>
                <div><div class="co-test-name">Gastón Martínez</div><div class="co-test-loc">Colombia</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Empecé desde cero y ya me estoy preparando para la certificación."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">RP</span>
                <div><div class="co-test-name">Ramiro Pintos</div><div class="co-test-loc">CDMX</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"El profesor Christian explica muy bien."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">JB</span>
                <div><div class="co-test-name">Julieta Bertoli</div><div class="co-test-loc">Buenos Aires</div></div>
            </div>
        </div>
    </div>
</section>
