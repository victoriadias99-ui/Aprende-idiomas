...
<head>
    <meta charset="utf-8">
    <title>Checkout · Italiano A1 | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/italiano-inicial/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">Ciao!</div>
            <div class="co-hero-viz-words">
                <span class="w1">Ciao</span>
                <span class="w2">Bella</span>
                <span class="w3">Vita</span>
            </div>
            <div class="co-hero-viz-tag">✦ Italiano</div>
        </div>
        <div>
            <div class="co-top-badge">🇮🇹 Italiano</div>
            <h1>Estás a un paso.<br><span class="grad">Italiano A1</span></h1>
            <p>Desde cero · Nivel inicial · Acceso inmediato después del pago · Garantía 7 días</p>
        </div>
    </div>
</section>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-order">
            <li>
                <div>
                    <div class="item-name">Italiano A1</div>
</div>
...
<li><span class="check">✓</span> Soporte de profes online</li>
            ...
            <li><span class="check">✓</span> Apto camino a ciudadanía</li>
        </ul>
    </aside>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"Nunca había estudiado italiano, parece difícil pero no lo es."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">RT</span>
                <div><div class="co-test-name">Ramiro Testa</div><div class="co-test-loc">Rosario</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"El profesor explica muy bien y es muy claro."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">MP</span>
                <div><div class="co-test-name">Maxi Pintos</div><div class="co-test-loc">Córdoba</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Me gustó especialmente la parte de lecturas."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">MB</span>
                <div><div class="co-test-name">Martina B.</div><div class="co-test-loc">Buenos Aires</div></div>
            </div>
        </div>
    </div>
</section>
