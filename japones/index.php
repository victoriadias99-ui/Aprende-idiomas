...
<head>
    <meta charset="utf-8">
    <title>Japonés — Curso Online desde cero | Aprende Idiomas</title>
    <meta name="description" content="Curso de japonés nivel inicial. Desde cero, +28 clases, certificado oficial, comunidad y acceso de por vida.">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            /* Colores Italia */
            --it-green: #be123c;
            --it-green-deep: #881337;
            --it-green-soft: #fee2e2;
            --it-red: #be123c;
            --it-red-soft: #fee2e2;
            --it-cream: #fef9f0;
            ...
            --shadow-it: 0 12px 32px rgba(190,18,60,.32);
        ...
        .hero {
            ...
            background:
                ...
                radial-gradient(ellipse 60% 50% at 0% 100%, rgba(190,18,60,.10), transparent 60%),
                #fff;
        }
        .hero::after {
            content: '';
        ...
        .btn-it:hover {
            ...
            box-shadow: 0 16px 40px rgba(190,18,60,.45);
        }
        .btn-light {
            background: #fff;
            color: var(--ink);
        ...
        .syllabus-inner::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 80% 20%, rgba(190,18,60,.30), transparent 50%),
        ...
        .testimonials::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 80% 20%, rgba(190,18,60,.20), transparent 50%),
        ...
        .testimonials .section-head .eyebrow { background: rgba(190,18,60,.2); color: #5fd687; }
...
<section class="hero">
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-eyebrow">🇯🇵 Japonés · Inicial · Desde cero</div>
            <h1>Aprendé japonés <span class="grad">desde cero</span></h1>
            <p class="hero-sub">Una de las culturas más fascinantes del mundo. Comenzá desde los kana (hiragana, katakana) y avanzá hasta mantener conversaciones básicas. Acceso de por vida.</p>
...
<li><span class="check">✓</span> Soporte de profes online</li>
        ...
        <div class="hero-visual">
            <span class="hero-flag"><span class="flag-icon">🇯🇵</span> こんにちは</span>
            <img src="../img/japon.png" alt="Japonés" class="hero-img">
            <div class="hero-rating">
                <div class="hero-rating-stars">★★★★★</div>
                <div class="hero-rating-text"><b>4.9 de 5</b>+900 alumnos</div>
            </div>
        </div>
    </div>
</section>
...
<section class="banner-it">
    ...
    <h2>La mejor forma de aprender japonés a nivel mundial</h2>
</section>

<!-- ============ INTRO PROSE ============ -->
<section class="prose">
    <div class="prose-inner">
        <p>El japonés es hablado por más de <b>125 millones de personas</b> y es la puerta a una cultura única: anime, cine, gastronomía, videojuegos. Aprenderlo te abre un mundo entero.</p>
        <p>Este curso te enseña los <span class="highlight-text">2 silabarios base</span> (hiragana y katakana), las 4 formas verbales más usadas, vocabulario esencial y frases para conversaciones cotidianas.</p>
        <div class="no-req">✦ Sin requisitos previos</div>
        <div class="prose-stats">
            <span class="stars">★★★★★</span>
            <span><b>+900 estudiantes</b> ya empezaron</span>
        </div>
    </div>
</section>
...
<section class="learn">
    <div class="learn-inner">
        <img src="../img/japon.png" alt="Aprenderás japonés" class="learn-img">
        <div class="learn-content">
            ...
            <ul class="learn-list">
                <li><span class="check">1</span> Hiragana (ひらがな) — 46 caracteres</li>
                <li><span class="check">2</span> Katakana (カタカナ) — 46 caracteres</li>
                <li><span class="check">3</span> Forma Diccionario, Masu, Nai y Te</li>
                <li><span class="check">4</span> Partículas (は, を, が, の, に)</li>
                <li><span class="check">5</span> Números, colores y vocabulario diario</li>
                <li><span class="check">6</span> Saludos y frases de conversación</li>
            </ul>
        </div>
    </div>
</section>
...
<section class="syllabus" id="temario">
    <div class="syllabus-inner">
        <div class="syllabus-content">
            ...
            <p>+28 clases paso a paso, organizadas para que avances sin perderte.</p>

            <details>
                <summary class="syllabus-toggle">
                    <span>Ver temario completo (28 clases)</span>
                    <span class="arrow">▼</span>
                </summary>
                <ul class="syllabus-list">
                    <li><span class="num">01</span> Introducción al japonés</li>
                    <li><span class="num">02</span> Hiragana: vocales (a-i-u-e-o)</li>
                    <li><span class="num">03</span> Hiragana: consonantes (k-s-t-n)</li>
                    <li><span class="num">04</span> Hiragana: resto (h-m-y-r-w)</li>
                    <li><span class="num">05</span> Dakuten y handakuten</li>
                    <li><span class="num">06</span> Yōon (combinaciones)</li>
                    <li><span class="num">07</span> Katakana: filas básicas</li>
                    <li><span class="num">08</span> Katakana: completo</li>
                    <li><span class="num">09</span> Cuándo usar hiragana vs katakana</li>
                    <li><span class="num">10</span> Pronombres personales</li>
                    <li><span class="num">11</span> Verbo Desu (es/son)</li>
                    <li><span class="num">12</span> Números 1-100</li>
                    <li><span class="num">13</span> Colores</li>
                    <li><span class="num">14</span> Días y meses</li>
                    <li><span class="num">15</span> Familia</li>
                    <li><span class="num">16</span> Comida básica</li>
                    <li><span class="num">17</span> Partícula は (wa)</li>
                    <li><span class="num">18</span> Partícula を (wo)</li>
                    <li><span class="num">19</span> Partícula が (ga)</li>
                    <li><span class="num">20</span> Forma Masu (presente/futuro)</li>
                    <li><span class="num">21</span> Forma Nai (negativo)</li>
                    <li><span class="num">22</span> Forma Te (encadenar acciones)</li>
                    <li><span class="num">23</span> Forma Diccionario (informal)</li>
                    <li><span class="num">24</span> Adjetivos i y na</li>
                    <li><span class="num">25</span> Kanji básicos (日, 月, 人, 本)</li>
                    <li><span class="num">26</span> Primera lectura con hiragana</li>
                    <li><span class="num">27</span> Conversación cotidiana</li>
                    <li><span class="num">28</span> Ejercicios finales</li>
                </ul>
            </details>
        </div>
    </div>
    ...
    <div class="testimonials-inner">
        ...
        <div class="testimonials-grid">
            <div class="testimonial">
                ...
                <p class="testimonial-text">"Soy fan del anime y este curso me dio la base que necesitaba."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">ID</span>
                    <div class="testimonial-info"><span class="testimonial-name">Ignacio D.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"El hiragana parecía imposible, ahora lo leo tranquilo."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">YC</span>
                    <div class="testimonial-info"><span class="testimonial-name">Yamila C.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Las 4 formas verbales quedaron clarísimas."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">LF</span>
                    <div class="testimonial-info"><span class="testimonial-name">Lautaro F.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Me voy a Japón el año que viene, este curso es perfecto."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">MV</span>
                    <div class="testimonial-info"><span class="testimonial-name">Micaela V.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Excelente. Vale cada peso."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">BO</span>
                    <div class="testimonial-info"><span class="testimonial-name">Bruno O.</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Los katakana para palabras extranjeras me ayudaron un montón."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">AP</span>
                    <div class="testimonial-info"><span class="testimonial-name">Antonella P.</span></div>
                </div>
            </div>
...
<section class="faq">
    ...
    <div class="faq-inner">
        ...
        <details class="faq-item">
            ...
            <div class="faq-body">No hay requisitos previos. Este curso es para que avances con japonés a tu propio ritmo.</div>
        </details>
        <details class="faq-item">
...
<section class="final-cta">
    <div class="final-cta-inner">
        <img src="../img/japon.png" alt="Empezá hoy" class="final-cta-img">
        <div class="final-cta-content">
            <div class="hero-eyebrow">🇯🇵 Empezá hoy</div>
            <h2>Sumá japonés a tu CV</h2>
