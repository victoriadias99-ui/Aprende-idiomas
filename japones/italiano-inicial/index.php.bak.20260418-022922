            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5" style="">
                        <div class=" py-auto">
                            <img src="img/italiano1.jpg" class="img-fluid my-auto py-auto align-items-center justify-content-center pt-5 pt-md-5 mt-md-5" alt="curso de power bi">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="section-heading ">
                            ...
                            <h1 class="mt-4  " style=""><b>APRENDE <span style="font-family: montserrat_black ;">ITALIANO DESDE CERO!</span></b></h1>
                        </div>
                        <div class="feature-list mt-4">
                            <ul class="font-weight-light" style="font-family: montserrat_light ;">
                                <li class="wow fadeIn  animated" data-wow-delay="0.1" style="visibility: visible;-webkit-animation-delay: 0.1; -moz-animation-delay: 0.1; animation-delay: 0.1;"><i class="fas fa-check-circle text-dark"></i> + 25 clases paso a paso!</li>
                                <li class="wow fadeIn  animated" data-wow-delay="0.1" style="visibility: visible;-webkit-animation-delay: 0.1; -moz-animation-delay: 0.1; animation-delay: 0.1;"><i class="fas fa-check-circle text-dark"></i> + 200 Ejercicios</li>
                                ...
                                <li class="wow fadeIn animated" data-wow-delay="0.3" style="visibility: visible;-webkit-animation-delay: 0.3; -moz-animation-delay: 0.3; animation-delay: 0.3;"><i class="fas fa-check-circle text-dark"></i> Estúdialo desde tu PC, notebook, tablet o Celular</li>
                            </ul>
                            ...
                            <p style="font-family: montserrat_bold">Aprende Idiomas es una empresa Latina. Éste precio es final y en es moneda local.</p>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9 px-md-5 mx-auto" style="">
                        <p class="font-weight-light lead mb-4">Hablado por más de 70 millones de personas, el italiano te ayudará navegar las calles de Roma en tu próximo viaje al extranjero. El italiano es la lengua romance arquetípica, y un buen punto de partida para aprender otros idiomas derivados del latín. </p>
                        <p class="lead mb-4">A través de este curso podrás aprender los verbos más usados, tiempos verbales básicos y mucho más para puedas mantener una conversación fluida. Explicado paso a paso en más de 25 clases paso a paso por nuestro profesor <span style="background-color:black; color:white;" class="p-1 font-w">con más de 15 años de trayectoria</span><br></p>
                        <hr>
                        ...
                        <div class="call-button mt-5">
                            ...
                            <p class="user_name d-inline pl-4 pr-4 font-weight-light">+3500 estudiantes</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container ">
                <div class="row mx-auto">
                    ...
                    <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                        <h2 class="my-3 mx-auto mx-md-1 mt-5 mt-md-1" style="font-family: montserrat_bold"> <b>Aprenderás:</b></h2>
                ...
                <div class="accordion mt-4" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample" style="">
                            <div class="card-body">Lo que vos decidas, + 25 clases para que hagas a tu ritmo y si decides seguir practicando el curso no tiene FIN! ya que contamos con un espacio para que puedas conversar con alumnos y practicar ejercicios.</div>
                        </div>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample" style="">
                            <div class="card-body">Sí, damos soporte 24/7. Podrás consultar cualquier duda por e-mail</div>
                        </div>
                    </div>
                    <div class="call-button mt-5">
            ...
            <div class="container">
                ...
                <div class="accordion mt-4" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample" style="">
                            <div class="card-body">Sí, damos soporte 24/7. Podrás consultarnos cualquier duda por e-mail</div>
                        </div>
                    </div>
                </div>
                <!--TEMARIO -->
                                        ...
                                        <div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordion" style="">
                                            <div class="card-body">
                                                <div class=" show ">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <a href="" class="sc-roll hvr-sweep-to-top  wow flipInX animated text-dark" data-wow-delay="0.2s" style="visibility: visible;-webkit-animation-delay: 0.2s; -moz-animation-delay: 0.2s; animation-delay: 0.2s;"><b>Quieres más conocimientos? Mira el nivel 2 👉 </b></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" style="">
                        <div class="section-heading">
                            ...
                            <h1 class="font-weight-bold text-left" style="font-family: montserrat_black">Suma Italiano a tu CV</h1>
                        </div>
                        <div class="feature-list mt-4">
                        ...
                        <div class="call-button mt-5">
                            <div class="row">
                                ...
                                <div class="col-md-6 payments ">
                                    <img src="../img/front_pay.png" class="img-fluid wow flipInX animated px-5 px-md-0 mt-md-0 mt-3 " data-wow-delay="0.3s" alt="payments" style="visibility: visible;-webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;">
                                </div>
                            </div>
                        </div>
                    </div>
