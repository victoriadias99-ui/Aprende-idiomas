...
<head>
    <meta charset="utf-8">
    <title>Checkout · Japonés | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/japones/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">こんにちは</div>
        ...
        <div>
            <div class="co-top-badge">🇯🇵 Japonés</div>
            <h1>Estás a un paso.<br><span class="grad">Japonés</span></h1>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-order">
            <li>
                <div>
                    <div class="item-name">Japonés</div>
</div>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"Soy fan del anime y este curso me dio la base que necesitaba."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">ID</span>
                <div><div class="co-test-name">Ignacio D.</div><div class="co-test-loc">Buenos Aires</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"El hiragana parecía imposible, ahora lo leo tranquilo."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">YC</span>
                <div><div class="co-test-name">Yamila C.</div><div class="co-test-loc">Córdoba</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Las 4 formas verbales quedaron clarísimas."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">LF</span>
                <div><div class="co-test-name">Lautaro F.</div><div class="co-test-loc">Rosario</div></div>
            </div>
        </div>
    </div>
</section>
