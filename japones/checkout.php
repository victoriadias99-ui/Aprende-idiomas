...
<html>
    ...
    <body style="font-family: montserrat_regular;">
        ...
        <div class="pt-5" style="background-color:#F00">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/japon2.png"> </div>
                    ...
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0 text-dark">Curso de Japonés Inicial</h6> <small class="text-muted">De por vida</small>
                        ...
                        <div class="row mx-2 ">
                            <div class="col-md-12 text-dark">
                                ...
                                <ul>
                                    ...
                                    <li> <i class="fas fa-check-square " style="color:#00a8f3;"></i> 23 clases</li>
                            ...
                            <div class=" col-md-12" style="">
                                <div class=" mb-0 text-dark">
                                    <p>"Con este curso pude introducirme en este idioma tan genial. Amo el Japonés
