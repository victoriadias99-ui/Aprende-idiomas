...
<section class="hero">
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-eyebrow">🇮🇹 Italiano · Nivel A2 · Intermedio</div>
            <h1>Italiano nivel <span class="grad">intermedio A2</span></h1>
            <p class="hero-sub">Continuá tu camino tras el A1. Tiempos verbales más complejos, vocabulario amplio y herramientas para conversar con naturalidad. Apto camino a ciudadanía.</p>
...
<section class="prose">
    <div class="prose-inner">
        <p>El nivel A2 es el puente que te lleva a una <b>conversación fluida</b>. Pasás de entender frases simples a manejar diálogos cotidianos con confianza, ideal para vivir en Italia o continuar hacia ciudadanía.</p>
        <p>Construido como continuación natural del A1, este curso profundiza con <span class="highlight-text">tiempos verbales del pasado</span> y vocabulario amplio para situaciones reales.</p>
        <div class="no-req">✦ Sin requisitos previos</div>
        <div class="prose-stats">
            <span class="stars">★★★★★</span>
            <span><b>+1.800 estudiantes</b> ya empezaron</span>
        </div>
    </div>
</section>
...
<section class="learn">
    <div class="learn-inner">
        ...
        <div class="learn-content">
            ...
            <ul class="learn-list">
                <li><span class="check">1</span> Passato prossimo y imperfetto</li>
                <li><span class="check">2</span> Verbos modales (potere, volere, dovere)</li>
                <li><span class="check">3</span> Pronombres directos e indirectos</li>
                <li><span class="check">4</span> Comparativos y superlativos</li>
                <li><span class="check">5</span> Conversación en restaurante, viaje, trabajo</li>
                <li><span class="check">6</span> Lecturas y comprensión auditiva</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="syllabus-content">
            ...
            <details>
                ...
                <ul class="syllabus-list">
                    <li><span class="num">01</span> Repaso A1</li>
                    <li><span class="num">02</span> Passato prossimo con avere</li>
                    <li><span class="num">03</span> Passato prossimo con essere</li>
                    <li><span class="num">04</span> Imperfetto</li>
                    <li><span class="num">05</span> Diferencias passato prossimo vs imperfetto</li>
                    <li><span class="num">06</span> Pronombres directos</li>
                    <li><span class="num">07</span> Pronombres indirectos</li>
                    <li><span class="num">08</span> Pronombres combinados</li>
                    <li><span class="num">09</span> Verbo Potere</li>
                    <li><span class="num">10</span> Verbo Volere</li>
                    <li><span class="num">11</span> Verbo Dovere</li>
                    <li><span class="num">12</span> Verbo Sapere</li>
                    <li><span class="num">13</span> Comparativos di maggioranza</li>
                    <li><span class="num">14</span> Comparativos di minoranza</li>
                    <li><span class="num">15</span> Superlativos</li>
                    <li><span class="num">16</span> Aggettivi possessivi</li>
                    <li><span class="num">17</span> Pronomi possessivi</li>
                    <li><span class="num">18</span> Ci e Ne</li>
                    <li><span class="num">19</span> Preposizioni semplici</li>
                    <li><span class="num">20</span> Preposizioni articolate</li>
                    <li><span class="num">21</span> Avverbi di tempo</li>
                    <li><span class="num">22</span> Avverbi di luogo</li>
                    <li><span class="num">23</span> Vocabolario: cibo</li>
                    <li><span class="num">24</span> Vocabolario: viaggio</li>
                    <li><span class="num">25</span> Vocabolario: lavoro</li>
                    <li><span class="num">26</span> Lectura 1: Una giornata a Roma</li>
                    <li><span class="num">27</span> Lectura 2: Al ristorante</li>
                    <li><span class="num">28</span> Listening: Conversazioni quotidiane</li>
    ...
    <div class="testimonials-inner">
        ...
        <div class="testimonials-grid">
            <div class="testimonial">
                ...
                <p class="testimonial-text">"El passato prossimo me costaba. Acá lo entendí fácil."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">LM</span>
                    <div class="testimonial-info"><span class="testimonial-name">Laura Mendoza</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Vivo en Italia ahora. Este curso me preparó perfecto."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">GR</span>
                    <div class="testimonial-info"><span class="testimonial-name">Gabriel Romano</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Los pronombres combinados al fin tienen sentido."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">SF</span>
                    <div class="testimonial-info"><span class="testimonial-name">Sofía Ferraris</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Excelente continuación del A1. Muy recomendado."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">EC</span>
                    <div class="testimonial-info"><span class="testimonial-name">Esteban Conti</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Las lecturas con audio son geniales para el oído."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">MA</span>
                    <div class="testimonial-info"><span class="testimonial-name">María Augustini</span></div>
                </div>
            </div>

            <div class="testimonial">
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">"Camino a la ciudadanía. Este curso es clave."</p>
                <div class="testimonial-author">
                    <span class="testimonial-avatar">PB</span>
                    <div class="testimonial-info"><span class="testimonial-name">Pablo Bertinelli</span></div>
                </div>
            </div>
