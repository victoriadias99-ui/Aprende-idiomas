...
<head>
    <meta charset="utf-8">
    <title>Checkout · Italiano A2 | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/italiano-a2/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">Bravo!</div>
            <div class="co-hero-viz-words">
                <span class="w1">Andiamo</span>
                <span class="w2">Dolce</span>
                <span class="w3">Amore</span>
            </div>
            <div class="co-hero-viz-tag">✦ Italiano</div>
        </div>
        <div>
            <div class="co-top-badge">🇮🇹 Italiano</div>
            <h1>Estás a un paso.<br><span class="grad">Italiano A2</span></h1>
            <p>Nivel intermedio · Continuación del A1 · Acceso inmediato después del pago · Garantía 7 días</p>
        </div>
    </div>
</section>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-order">
            <li>
                <div>
                    <div class="item-name">Italiano A2</div>
</div>
        ...
        <ul class="co-feat">
            <li><span class="check">✓</span> +25 clases intermedias</li>
            <li><span class="check">✓</span> Passato prossimo e imperfetto</li>
            <li><span class="check">✓</span> Pronombres directos e indirectos</li>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"El passato prossimo me costaba. Acá lo entendí fácil."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">LM</span>
                <div><div class="co-test-name">Laura Mendoza</div><div class="co-test-loc">Rosario</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Vivo en Italia ahora. Este curso me preparó perfecto."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">GR</span>
                <div><div class="co-test-name">Gabriel Romano</div><div class="co-test-loc">Roma</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Los pronombres combinados al fin tienen sentido."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">SF</span>
                <div><div class="co-test-name">Sofía Ferraris</div><div class="co-test-loc">Córdoba</div></div>
            </div>
        </div>
    </div>
</section>
