...
<head>
    <meta charset="utf-8">
    <title>Checkout · Inglés Nivel 2 | Aprende Idiomas</title>
...
<nav class="co-nav">
    <div class="co-nav-inner">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end">
            <a href="/ingles-nivel-dos/" class="co-nav-back">← Volver al curso</a>
...
<section class="co-top">
    <div class="co-top-inner">
        <div class="co-hero-viz">
            ...
            <div class="co-hero-viz-greeting">Let's go!</div>
            <div class="co-hero-viz-words">
                <span class="w1">Speak</span>
                <span class="w2">Grow</span>
                <span class="w3">Fluent</span>
            </div>
            <div class="co-hero-viz-tag">✦ English</div>
        </div>
        <div>
            <div class="co-top-badge">🇺🇸 Inglés</div>
            <h1>Estás a un paso.<br><span class="grad">Inglés Nivel 2</span></h1>
            <p>Intermedio · Continuación del N1 · Acceso inmediato después del pago · Garantía 7 días</p>
        </div>
    </div>
</section>
...
<main class="co-main">
    ...
    <aside class="co-card">
        ...
        <ul class="co-order">
            <li>
                <div>
                    <div class="item-name">Inglés Nivel 2</div>
</div>
        ...
        <ul class="co-feat">
            <li><span class="check">✓</span> +30 clases avanzadas</li>
            <li><span class="check">✓</span> Tiempos verbales complejos</li>
            <li><span class="check">✓</span> Conversación fluida</li>
            <li><span class="check">✓</span> Acceso ilimitado</li>
...
<section class="co-testimonials">
    ...
    <div class="co-tests-grid">
        <div class="co-test">
            ...
            <p class="co-test-text">"Justo lo que necesitaba para superar el plateau."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">CN</span>
                <div><div class="co-test-name">Carla Núñez</div><div class="co-test-loc">Rosario</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Los conditionals me costaban, acá los entendí fácil."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">JT</span>
                <div><div class="co-test-name">Joaquín Torres</div><div class="co-test-loc">Córdoba</div></div>
            </div>
        </div>
        <div class="co-test">
            <div class="co-test-stars">★★★★★</div>
            <p class="co-test-text">"Conversación fluida en pocos meses. Muy recomendado."</p>
            <div class="co-test-author">
                <span class="co-test-avatar">PG</span>
                <div><div class="co-test-name">Paula Giménez</div><div class="co-test-loc">Mendoza</div></div>
            </div>
        </div>
    </div>
</section>
