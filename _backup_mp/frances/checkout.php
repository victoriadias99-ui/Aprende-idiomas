...
<html>
    ...
    <body style="font-family: montserrat_regular;">
        ...
        <!-- Website Sections -->
        <div class="pt-5" style="background-color:#051440">
            <div class="container">
                <div class="row">
                    <div class="col-md-4  mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="img/1.png"> </div>
                    ...
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0 text-dark">Curso de Frances</h6> <small class="text-muted">De por vida</small>
                        ...
                        <div class="row mx-2 ">
                            <div class="col-md-12 text-dark">
                                ...
                                <ul>
                                    ...
                                    <li> <i class="fas fa-check-square " style="color:#00a8f3;"></i>  2 hs de video</li>
                            ...
                            <div class=" col-md-12" style="">
                                <div class=" mb-0 text-dark">
                                    <p>"Excelente!
                                        Muy completo el curso, ideal para principiantes"</p>
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Gaston Martinez</b>, Ciudad de Buenos Aires</div>
                                </div>
                                <hr>
                                <div class=" mb-0 text-dark">
                                    <p>"Lo recomiendo empezé desde cero y ya me estoy preparando para la certificación"</p>
                                    <div class="rating-user d-inline">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Ramiro Pintos</b>, Ciudad de Buenos Aires</div>
                                </div>
                                <hr>
                                <div class=" mb-0 text-dark">
                                    <p>"El profesor Christian explica muy bien"</p>
                                    <div class="rating-user d-inline">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Julieta Bertoli</b>, Ciudad de Buenos Aires</div>
                                </div>
                            </div>
            ...
            <div class="py-5 text-center">
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" target="_blank" href="https://api.whatsapp.com/send?phone=5491164402284&amp;text=Hola!%20Te%20escribo%20por%20el%20Curso%20de%20Francés"> <img class="img-fluid d-block mx-auto mx-md-1" src="img/whatsapp.jpg"></a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
