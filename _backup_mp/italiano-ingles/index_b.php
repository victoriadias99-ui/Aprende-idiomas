...
<html>
    <head>
        <title>Aprende Idiomas - Pack Idioma</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="feature-list mt-4">
                            ...
                            <h3 class="mt-md-4 p-2 mt-3 col-8 col-md-6 text-center bg-success text-white" style="background-color:#FF0000; color:black;font-family: montserrat_regular;"><strike>$8.999</strike><span class="font-weight-bold "> $3599</span></h3>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" style="">
                        ...
                        <div class="feature-list mt-4">
                            ...
                            <h3 class="mt-md-4 p-2 mt-3 col-8 col-md-6 text-center bg-danger text-white" style="background-color:#f3c910; color:black;font-family: montserrat_bold;"><strike>$8.999</strike><span class="font-weight-bold "> $3599</span></h3>
                        </div>
                        <div class="call-button mt-5">
                            <div class="row">
                                <div class="col-md-6">
