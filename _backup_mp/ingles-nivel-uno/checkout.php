                    ...
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                <div>
                                    <h6 class="my-0 text-dark">Curso de Inglés Nivel 1</h6> <small class="text-muted">De por vida</small>
                        ...
                        <div class="row mx-2 ">
                            <div class="col-md-12 text-dark">
                                ...
                                <ul>
                                    ...
                                    <li> <i class="fas fa-check-square " style="color:#00a8f3;"></i> +45 clases</li>
                                    <li><i class="fas fa-check-square " style="color:#00a8f3;"></i> + 100 Ejericios Prácticos</li>
