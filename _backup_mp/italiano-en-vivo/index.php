                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="section-heading ">
                            ...
                            <h1 class="mt-4  " style=""><b>APRENDÉ <span style="font-family: montserrat_black ;">ITALIANO DESDE CERO!</span></b></h1>
                        </div>
                        <div class="feature-list mt-4">
                            <ul class="font-weight-light" style="font-family: montserrat_light ;">
                                ...
                                <li class="wow fadeIn animated" data-wow-delay="0.2" style="visibility: visible;-webkit-animation-delay: 0.2; -moz-animation-delay: 0.2; animation-delay: 0.2;"> <i class="fas fa-check-circle text-dark"></i> +2 Clases en vivo con profesor</li>
								<li class="wow fadeIn animated" data-wow-delay="0.2" style="visibility: visible;-webkit-animation-delay: 0.2; -moz-animation-delay: 0.2; animation-delay: 0.2;"> <i class="fas fa-check-circle text-dark"></i> Acceso a la academia online</li>
                                <li class="wow fadeIn animated" data-wow-delay="0.2" style="visibility: visible;-webkit-animation-delay: 0.2; -moz-animation-delay: 0.2; animation-delay: 0.2;"> <i class="fas fa-check-circle text-dark"></i> +50 Ejercicios prácticos</li>
                            ...
                            <h3 class="mt-md-4 p-2 mt-3 col-8 col-md-6 text-center bg-success text-white" style="background-color:#f3c910; color:black;font-family: montserrat_regular;"><strike>$19.999</strike><span class="font-weight-bold "> $9999</span></h3>
                ...
                <div class="accordion mt-4" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample" style="">
							...
							Tambien con nuestro curso brindamos 2 clases en vivo para que coordines con nuestro profesor de italiano.</div>
                        </div>
                    </div>
                    <div class="card">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" style="">
                        ...
                        <div class="feature-list mt-4">
                            ...
                            <h3 class="mt-md-4 p-2 mt-3 col-8 col-md-6 text-center bg-danger text-white" style="background-color:#f3c910; color:black;font-family: montserrat_bold;"><strike>$19.999</strike><span class="font-weight-bold "> $9999</span></h3>
                        </div>
                        <div class="call-button mt-5">
                            <div class="row">
                                <div class="col-md-6">
