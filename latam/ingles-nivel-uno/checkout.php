...
$curso = 'ingles_uno'; // Variable que contiene el id del curso a visualizar
        ...
        <div class="text-white jp_banner_jobs_categories_wrapper bg-white float_left pt-5 pb-0 mx-auto mx-1">
                            ...
                            <div class=" col-md-12" style="">
                                <div class=" mb-0 text-dark">
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Gaston Martinez</b>, Colombia</div>
                                </div>
                                <hr>
                                <div class=" mb-0 text-dark">
                                    ...
                                    <div class="blockquote-footer">
                                        <b>Ramiro Pintos</b>, Ciudad de México</div>
                                </div>
                                <hr>
                                <div class=" mb-0 text-dark">
            ...
            <div class="py-5 text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-dark">
                            <h3 style="font-family:montserrat_bold">¿Quieres hablar con nosotros? ¡Escrébenos ahora!</h3>
                            <hr>
                        </div>
                    </div>
