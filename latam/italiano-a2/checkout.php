                    ...
                    <div class="col-md-5 mx-auto  my-auto" style="padding: 80px 20px;">
                        ...
                        <div class="row mx-2 ">
                            ...
                            <div class=" col-md-12" style="">
                                ...
                                <hr>
                                <div class=" mb-0 text-dark">
                                    <p>"Lo recomiendo, vi los 2 niveles de italiano"</p>
                                    <div class="rating-user d-inline">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
            ...
            <div class="py-5 text-center">
                <div class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 text-center">
                            <a class="" target="_blank" href="https://api.whatsapp.com/send?phone=5491164402284&amp;text=Hola!%20Te%20escribo%20por%20el%20Curso%20de%20ItalianoA2"> <img class="img-fluid d-block mx-auto mx-md-1" src="img/whatsapp.jpg"></a>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
