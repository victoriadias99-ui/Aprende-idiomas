                ...
                <div class="row mx-auto">
                    ...
                    <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                        ...
                        <ul class="mx-auto mx-md-1 lead">
                            <li><i class="fas fa-check text-body" style="color:#f3c910;"></i> Tiempos verbales del Futuro</li>
                            <li><i class="fas fa-check text-dark" style="color:#f3c910;"></i> Verbo Esserci</li>
                ...
                <div class="accordion mt-4" id="accordionExample">
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0"><button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">#1 ¿Por cuánto tiempo lo tengo o lo puedo ver?</button></h5>
                        </div>
